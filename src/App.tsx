          ...
          <div className="bg-amber-500/15 dark:bg-amber-500/10 border border-amber-500/30 rounded-2xl p-3 mb-3 flex items-center justify-between gap-3 shrink-0 text-amber-900 dark:text-amber-200 shadow-sm">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <p className="text-xs font-medium leading-tight truncate">
                <span className="font-bold">Offline Mode Active:</span> Your edits and task updates are saved locally in browser storage and will automatically sync once your connection is restored.
              </p>
            </div>
            <button
              onClick={triggerSync}
