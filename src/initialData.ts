...
export const INITIAL_CATEGORIES: Category[] = [
  { id: 'cat-1', name: 'Computer Science', color: 'bg-indigo-100 text-indigo-700 border-indigo-200 dark:bg-indigo-950/40 dark:text-indigo-300 dark:border-indigo-900/50', type: 'Subject', userId: 'admin-spidereg2010' },
  { id: 'cat-2', name: 'Mathematics 101', color: 'bg-emerald-100 text-emerald-700 border-emerald-200 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900/50', type: 'Subject', userId: 'admin-spidereg2010' },
  { id: 'cat-3', name: 'Marketing Campaign', color: 'bg-amber-100 text-amber-700 border-amber-200 dark:bg-amber-950/40 dark:text-amber-300 dark:border-amber-900/50', type: 'Project', userId: 'admin-spidereg2010' },
  { id: 'cat-4', name: 'Fitness & Health', color: 'bg-rose-100 text-rose-700 border-rose-200 dark:bg-rose-950/40 dark:text-rose-300 dark:border-rose-900/50', type: 'Personal', userId: 'admin-spidereg2010' },
  { id: 'cat-5', name: 'Financial Planning', color: 'bg-sky-100 text-sky-700 border-sky-200 dark:bg-sky-950/40 dark:text-sky-300 dark:border-sky-900/50', type: 'Project', userId: 'admin-spidereg2010' }
];

export const INITIAL_TEAM_MEMBERS: TeamMember[] = [
  { id: 'admin-spidereg2010', name: 'Spider Eg', role: 'Super Admin', rank: 'Admin', avatar: 'SE', email: 'spidereg2010@gmail.com', password: 'Sspidereg.com' }
];
...
export const INITIAL_TASKS: Task[] = [
  {
    ...
    comments: [
      {
        id: 'c-1',
        authorId: 'admin-spidereg2010',
        authorName: 'Spider Eg',
        authorAvatar: 'SE',
        text: 'Relationship mapping for comments is verified and active.',
        createdAt: new Date(Date.now() - 3600000 * 4).toISOString()
      }
    ],
    recurring: 'None',
    isPinned: true,
    assignedTo: 'admin-spidereg2010'
  },
  {
    id: 'task-2',
