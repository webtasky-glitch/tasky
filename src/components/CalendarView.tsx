...
export const CalendarView: React.FC = () => {
  const { tasks, categories, teamMembers, addTask, currentUserProfile, user } = useTasky() as any;
  ...
  // Filter tasks using user and plan isolation
  const myTasks = tasks.filter((t: Task) => isTaskForUser(t, currentUserProfile, user, teamMembers));
  ...
  // Convert date object to YYYY-MM-DD using local time components to avoid UTC offset shifts
