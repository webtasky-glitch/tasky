          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-1.5 mb-1">
              ...
              {task.recurring && task.recurring !== 'None' && (
                <span className="flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full border leading-none font-medium bg-purple-500/10 text-purple-600 dark:text-purple-300 border-purple-500/20" title={`Repeats ${task.recurring}`}>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-1">
                ...
                <div className="space-y-1 sm:col-span-2">
                  ...
                  <AssigneeMultiSelector
                    ...
                    placeholder="Select one or more people in your plan..."
                  />
                </div>
              </div>
