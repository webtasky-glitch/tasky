    ...
    <div className="relative flex-1 flex flex-col h-full min-h-0 overflow-hidden">
      ...
      <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 z-30 pointer-events-auto">
        <motion.button
          ...
          title={isEl ? 'Γρήγορη Δημιουργία Εργασίας (χωρίς αποχώρηση)' : 'Quick Create Task (without leaving workspace)'}
          aria-label={isEl ? 'Γρήγορη Δημιουργία Εργασίας' : 'Quick Create Task'}
        >
          ...
          <span className="font-semibold tracking-tight">{isEl ? 'Νέα Εργασία' : 'New Task'}</span>
